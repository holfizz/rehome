		...
		<div className='min-h-screen bg-black text-white overflow-x-hidden'>
			...
			<section className='relative pt-32 pb-20 md:pt-40 md:pb-32 bg-gradient-to-br from-black via-slate-900 to-black flex items-center justify-center overflow-hidden'>
				...
				<div className='relative z-10 container mx-auto px-6 text-center max-w-4xl'>
					...
					>
						Профессиональный дизайн интерьера от концепции до реализации
					</motion.p>
				</div>
			</section>
			...
			>
				<div className='container mx-auto px-6 max-w-6xl'>
					<motion.h2
						variants={fadeInUp}
						className='text-4xl md:text-6xl font-thin text-center mb-20 tracking-tighter text-white'
					>
						НАШИ УСЛУГИ
					</motion.h2>
						...
						{[
							{
								...
								description: 'Полный дизайн-проект квартиры любой площади',
								price: 'от 2 500 ₽/м²',
								features: [
									'Планировка',
									'3D-визуализация',
							...
							{
								title: 'Дизайн домов',
								description: 'Комплексный дизайн частных домов и коттеджей',
								price: 'от 3 000 ₽/м²',
								features: ['Планировка', 'Фасад', 'Ландшафт', 'Интерьер'],
							},
							{
								title: 'Коммерческий дизайн',
								description: 'Дизайн офисов, ресторанов, магазинов',
								price: 'от 4 000 ₽/м²',
								features: ['Брендинг', 'Эргономика', 'Функциональность'],
							},
							{
								title: 'Авторский надзор',
								description: 'Контроль качества выполнения ремонтных работ',
								price: 'от 25 000 ₽',
								features: [
									'Контроль качества',
									'Консультации',
							...
							{
								title: 'Декорирование',
								description: 'Подбор мебели, текстиля и аксессуаров',
								price: 'от 15 000 ₽',
								features: ['Подбор мебели', 'Текстиль', 'Аксессуары'],
							},
							{
								title: 'Консультации',
								description: 'Персональные консультации по дизайну',
								price: 'от 3 000 ₽',
								features: ['Онлайн/офлайн', '2 часа', 'Рекомендации'],
							},
						].map((service, index) => (
							<motion.div
								key={index}
							...
							>
								<div className='bg-white/8 backdrop-blur-3xl rounded-3xl border border-white/20 shadow-[0_8px_32px_rgba(255,255,255,0.1)] hover:bg-white/12 hover:border-white/30 transition-all duration-300 p-8 h-full'>
